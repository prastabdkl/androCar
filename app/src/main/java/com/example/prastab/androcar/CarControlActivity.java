package com.example.prastab.androcar;
...
CarControlActivity extends AppCompatActivity implements SensorEventListener {
    private String url = "http://192.168.43.1:8085/browserfs.html";
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(com.example.prastab.androcar.R.layout.activity_carcontrol);

        // getting the bluetooth adapter build inside the android phone
        myBluetooth = BluetoothAdapter.getDefaultAdapter();

        // initializing the components for buttons
        backwardBtnn = (ImageView)findViewById(com.example.prastab.androcar.R.id.Left_Btn);
        forwardBtnn = (ImageView)findViewById(com.example.prastab.androcar.R.id.Right_Btn);
        hornBtnn =(ImageView)findViewById(com.example.prastab.androcar.R.id.horn_btn);
        headlightBtnn = (ImageView)findViewById(com.example.prastab.androcar.R.id.headLight_btnn);
        rearlightBtnn = (ImageView)findViewById(com.example.prastab.androcar.R.id.rearLight_btnn);
        ...
        myTV = (TextView) findViewById(com.example.prastab.androcar.R.id.textView);

        // executing the AsyncTask for checking the bluetooth connection status in background
        new ConnectBT().execute();

        //webview
        WebView webView =(WebView) findViewById(com.example.prastab.androcar.R.id.webView);
...
//      webView.getSettings().setPluginsEnabled(1);
        //webView.getSettings().setDefaultZoom(WebSettings.ZoomDensity.FAR);
        //webView.loadData("<html><head><style type=\"text/css\">body{margin:0 auto;text-align:center;}</style></head><body>"+arrayListAds.‌​get(0).getUrl()+"</b‌​ody></html>", "text/html", "utf8");
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch(motionEvent.getAction()){
                    ...
                    case MotionEvent.ACTION_DOWN:
                        forwardBtnn.setImageResource(com.example.prastab.androcar.R.drawable.forward_btnn);
                        forwardBtnnHold = true;
                        break;
                    // case: button is not being pressed now
                    case  MotionEvent.ACTION_UP:
                        forwardBtnn.setImageResource((com.example.prastab.androcar.R.drawable.forward_btn_idle));
        ...
        backwardBtnn.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch(motionEvent.getAction()){
                    case MotionEvent.ACTION_DOWN:
                        backwardBtnn.setImageResource(com.example.prastab.androcar.R.drawable.backward_btn);
                        backwardBtnnHold = true;
                        break;
                    case MotionEvent.ACTION_UP:
                        backwardBtnn.setImageResource(com.example.prastab.androcar.R.drawable.backward_btn_idle);
            ...
            public void onClick(View view) {
                ...
                if (btSocket != null){
                    try {
                        ...
                        if(head_on)
                            headlightBtnn.setImageResource(com.example.prastab.androcar.R.drawable.head_light_on);
                        else
                            headlightBtnn.setImageResource(com.example.prastab.androcar.R.drawable.head_light_off);
                    }
                    catch (IOException e){
                        Log.v(TAG, "headlight");
                    }
            ...
            public void onClick(View view) {
                ...
                if (btSocket != null){
                    try {
                        ...
                        if(rear_on)
                            rearlightBtnn.setImageResource(com.example.prastab.androcar.R.drawable.rear_light_on);
                        else
                            rearlightBtnn.setImageResource(com.example.prastab.androcar.R.drawable.rear_light_off);
                    }
                    catch (IOException e){
                        Log.v(TAG, "rearlight");
                    }
